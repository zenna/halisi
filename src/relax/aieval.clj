...
; ; The idea here was to crete an abstraction layer between the
; ; operations which underlie interpretation and the decisions involved
; ; To make an analogy with another kind of interpretation, running machine code
; ; It may appear like the interpreter for machine code has no decision making to do
; ; It simply passes the code to the machine, but a smarter interpreter may
; ; recognise that three instructions can be grouped into one
; ; Also abstract interpretation of machine code then involves making choices.

; ; The first goal is to seperate the process of interpreting from
